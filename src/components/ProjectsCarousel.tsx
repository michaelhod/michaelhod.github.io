...
const ProjectsCarousel = () => {
  ...
  const projects = [{
    ...
    description: "Developed a behavioural cloning approach using demonstrations to train four independent neural networks for action prediction. Designed an uncertainty detection system by comparing model outputs, triggering new demonstrations to improve accuracy. Enhanced reliability by incorporating high-reward actions into training and correcting cases where the robot stalled despite high confidence. Optimized performance through systematic resets and robust handling of edge cases, ensuring consistent goal completion.",
